...
<header class="about-heading"><div><p class="about-eyebrow">Research in focus</p><h2>Selected publications <span class="about-selection-note">(First author &amp; Corresponding)</span></h2></div><a class="about-scholar-link" href="{{ site.author.googlescholar }}" target="_blank" rel="noopener"><span class="about-scholar-title">Google Scholar <span aria-hidden="true">&#8599;</span></span><small>{{ site.data.scholar_citations.total_citations | default: 1500 }} citations</small></a></header>
